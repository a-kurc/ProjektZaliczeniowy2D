...
void Rocket::set_center(UINT32 x, UINT32 y) {
    center.x = x;
    center.y = y;
}
...
void Rocket::move_down() {
    center.y += 6;
}

void Rocket::set_attributes(int body_l_end_x, int body_r_end_x, int body_ends_y, int body_l_point_x, int body_r_point_x, int body_l_point_y,
...
void Rocket::set_fire(int t_end_line_x, int t_top_end_x, int m_end_line_x, int m_top_end_x, int b_end_line_x,
